 ...
 */
@Command(description = "Bootstrap", mixinStandardHelpOptions = true, version = Version.VERSION, subcommands = { Init.class, Hash.class, List.class, Add.class, Delete.class, Cat.class, Extract.class,
		StartGui.class })
