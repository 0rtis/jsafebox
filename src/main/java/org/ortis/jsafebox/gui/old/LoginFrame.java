...
import org.ortis.jsafebox.gui.old.tasks.InitTask;
import org.ortis.jsafebox.gui.old.tasks.OpenTask;
				...
				if (action != null)
					if (action == 0)
					{
						...
						if (openTask.getSafeExplorer() != null && configuration.getAutoHashCheck())
						{
							...
							this.configuration.addSafeFilePath(safeFile.getAbsolutePath());
